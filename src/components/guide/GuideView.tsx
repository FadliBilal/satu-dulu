...
export const GuideView: React.FC = () => {
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8 pb-28">
      {/* Header */}
      <div className="mb-8">
        <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-satublue-50 border border-satublue-200 text-xs text-satublue-800 mb-2.5 font-medium">
      ...
      {/* 3 Langkah Eksekusi */}
      <div className="mb-10">
        <h2 className="text-sm font-semibold text-slate-900 uppercase tracking-wider font-mono mb-4 text-satublue-700">
          3 Langkah Harian
        </h2>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Card className="p-5 bg-white border-slate-200/90 rounded-2xl flex flex-col justify-between shadow-xs">
            <div>
              <div className="w-8 h-8 rounded-xl bg-satublue-50 text-satublue-700 flex items-center justify-center font-mono font-bold text-xs border border-satublue-100 mb-3">
                01
              </div>
            ...
            <div className="mt-4 pt-3 border-t border-slate-100 text-[11px] text-satublue-600 font-medium">
        ...
        <div className="space-y-2.5">
          {[
            ...
            <div key={idx} className="p-4 rounded-xl bg-white border border-slate-200 shadow-xs">
              <h4 className="text-xs font-semibold text-slate-900 mb-1 flex items-center gap-2">
                <HelpCircle className="w-3.5 h-3.5 text-satublue-600 shrink-0" />
                <span>{faq.q}</span>
              </h4>
      ...
      {/* Action CTA */}
      <div className="p-6 rounded-2xl bg-satublue-50 border border-satublue-200 text-center">
