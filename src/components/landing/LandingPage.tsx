  ...
  return (
    <div className="min-h-screen relative overflow-x-hidden text-slate-900 selection:bg-satublue-100 bg-grid-subtle">
      ...
      <header className="fixed top-3 sm:top-5 inset-x-0 z-50 px-3 sm:px-6 flex justify-center pointer-events-none">
        <nav className="pointer-events-auto w-full max-w-3xl bg-white/85 backdrop-blur-xl border border-slate-200/90 rounded-full px-4 sm:px-6 py-2 sm:py-2.5 shadow-md shadow-slate-900/5 flex items-center justify-between transition-all">
          ...
          <Link href="/" className="flex items-center shrink-0">
            ...
            <span className="hidden md:inline-block text-[11px] text-slate-400 border-l border-slate-200 pl-2 ml-2 font-normal">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
            <Link
              href="/login"
              className="hidden sm:inline-block text-xs font-medium text-slate-600 hover:text-satublue-700 hover:bg-slate-100/60 px-3 py-1.5 rounded-full transition-colors whitespace-nowrap"
            >
              Masuk
            </Link>
      ...
      <section className="pt-24 sm:pt-36 md:pt-40 pb-16 px-4 sm:px-6 max-w-4xl mx-auto text-center relative">
        {/* Subtle pill tag */}
        <div className="inline-flex items-center gap-2 px-3 py-1 sm:px-3.5 sm:py-1.5 rounded-full bg-white/90 backdrop-blur-md border border-satublue-200 text-[11px] sm:text-xs text-satublue-900 mb-6 sm:mb-8 font-medium shadow-xs max-w-full">
        ...
        <h1 className="text-2xl sm:text-5xl md:text-6xl font-semibold tracking-tight text-slate-900 leading-[1.15] mb-4 sm:mb-6">
        ...
        <p className="text-sm sm:text-lg md:text-xl text-slate-600 max-w-2xl mx-auto font-normal leading-relaxed mb-8 sm:mb-10">
      ...
      {/* Section 1: 3 Pilar Utama (Minimalis & Bebas Beban) */}
      <section id="fitur" className="py-16 sm:py-20 px-4 sm:px-6 border-t border-slate-200/80 bg-white/70 backdrop-blur-xs">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            <div className="p-6 rounded-2xl border border-slate-200/80 bg-white shadow-xs hover:border-satublue-300 transition-all">
              <div className="w-9 h-9 rounded-xl bg-satublue-50 text-satublue-600 flex items-center justify-center mb-4 border border-satublue-100">
            ...
            <div className="p-6 rounded-2xl border border-slate-200/80 bg-white shadow-xs hover:border-satublue-300 transition-all">
              <div className="w-9 h-9 rounded-xl bg-emerald-50 text-emerald-600 flex items-center justify-center mb-4 border border-emerald-100">
      ...
      <section id="loop" className="py-16 sm:py-20 px-4 sm:px-6 max-w-4xl mx-auto w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          <div className="p-6 bg-white rounded-2xl border border-slate-200/90 shadow-xs">
            <span className="text-xs font-mono font-semibold text-satublue-700 bg-satublue-50 px-2.5 py-1 rounded-lg border border-satublue-100 inline-block mb-3">
              01 • TAMPUNG
            </span>
          ...
          <div className="p-6 bg-white rounded-2xl border border-slate-200/90 shadow-xs">
            <span className="text-xs font-mono font-semibold text-emerald-700 bg-emerald-50 px-2.5 py-1 rounded-lg border border-emerald-100 inline-block mb-3">
              03 • EKSEKUSI
            </span>
            <h4 className="text-base font-semibold text-slate-900 mb-1">
              Fokus Satu per Satu
