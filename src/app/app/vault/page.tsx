  ...
  return (
    <div>
      ...
      <div className="max-w-2xl mx-auto px-4 pt-6 flex items-center justify-center">
        <div className="inline-flex p-1 bg-satubg-subtle rounded-xl border border-gray-200">
          <button
            onClick={() => setActiveTab("vault")}
            className={`px-4 py-1.5 rounded-lg text-xs font-medium transition-all flex items-center gap-1.5 ${
              activeTab === "vault"
                ? "bg-white text-satutext-primary shadow-xs font-semibold"
                : "text-satutext-secondary hover:text-satutext-primary"
            }`}
          >
